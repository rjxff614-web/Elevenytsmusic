...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/NARUTO_MUC_SUPPORT")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/NARUTO_MUC_SUPPORT_GC")
        ...
        self.PING_IMG: str = getenv(
            "PING_IMG", "https://i.postimg.cc/bNKJvm7X/1775899341390.png")    # Ping command image
        self.START_IMG: str = getenv(
            "START_IMG", "https://i.postimg.cc/bNKJvm7X/1775899341390.png")  # Start command image
        self.RADIO_IMG: str = getenv(
            "RADIO_IMG", "https://i.postimg.cc/bNKJvm7X/1775899341390.png")    # Radio command image
